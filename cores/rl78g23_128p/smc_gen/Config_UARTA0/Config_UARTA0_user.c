...
static void r_Config_UARTA0_callback_sendend(void)
{
	...
	Set_Char_Serial_from_buf(5);
    if(0 != uart_transmit_callback_table[5])
    {
        (*uart_transmit_callback_table[5])();
    }
    /* End user code. Do not edit comment generated here */
}
...
static void r_Config_UARTA0_callback_receiveend(void)
{
	...
	Set_Char_Serial_to_buf(5);
    if(0 != uart_receive_callback_table[5])
    {
        (*uart_receive_callback_table[5])();
    }
    /* End user code. Do not edit comment generated here */
}

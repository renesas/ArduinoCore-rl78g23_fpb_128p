...
void r_Config_INTC_intp5_interrupt(void)
{
    ...
    if (g_afInterruptFuncTable[8] != NULL) {
        (*g_afInterruptFuncTable[8])();
    }
    /* End user code. Do not edit comment generated here */
}
...
void r_Config_INTC_intp6_interrupt(void)
{
    ...
    if (g_afInterruptFuncTable[7] != NULL) {
        (*g_afInterruptFuncTable[7])();
    }
    /* End user code. Do not edit comment generated here */
}
...
* Return Value : None
***********************************************************************************************************************/
void r_Config_INTC_intp8_interrupt(void)
{
...
* Return Value : None
***********************************************************************************************************************/
void r_Config_INTC_intp9_interrupt(void)
{

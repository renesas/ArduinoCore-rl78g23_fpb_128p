...
static void r_Config_UART3_callback_sendend(void)
{
	...
	Set_Char_Serial_from_buf(4);
    if(0 != uart_transmit_callback_table[4])
    {
        (*uart_transmit_callback_table[4])();
    }
    /* End user code. Do not edit comment generated here */
}
...
static void r_Config_UART3_callback_receiveend(void)
{
	...
	Set_Char_Serial_to_buf(4);
    if(0 != uart_receive_callback_table[4])
    {
        (*uart_receive_callback_table[4])();
    }
    /* End user code. Do not edit comment generated here */
}
...
* Return Value : None
***********************************************************************************************************************/
void r_Config_UART3_interrupt_send(void)
{
...
* Return Value : None
***********************************************************************************************************************/
void r_Config_UART3_interrupt_receive(void)
{
    uint8_t rx_data;
...
* Return Value : None
***********************************************************************************************************************/
void r_Config_UART3_interrupt_error(void)
{
    uint8_t err_type;

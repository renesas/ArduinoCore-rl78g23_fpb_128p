...
typedef enum
{
    ...
    ADCHANNEL18, ADCHANNEL19, ADCHANNEL20, ADCHANNEL21, ADCHANNEL22, ADCHANNEL23,
    ADCHANNEL24, ADCHANNEL25, ADCHANNEL26, ADTSCAP = 30U, ADTEMPERSENSOR0 = 128U, ADINTERREFVOLT
} e_ad_channel_t;
typedef enum
{
    ADNORMALINPUT,

...
#define _4E00_IIC20_DIVISOR                (0x4E00U)
#define IIC20_WAITTIME                     (13U)    /* wait for 5us as default,
                                                       please change the waiting time value according to the system */
#define IIC20_WAITTIME_2                   (53U)    /* wait for 20us as default,
                                                       please change the waiting time value according to the system */

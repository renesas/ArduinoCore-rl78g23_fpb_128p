...
// void r_Config_IIC20_interrupt (void) __attribute__ ((interrupt));
void r_Config_CSI20_UART2_interrupt_switching(void) __attribute__ ((interrupt));
...
void r_Config_CSI21_UART2_interrupt_switching(void) __attribute__ ((interrupt));
...
void r_Config_IIC11_UART1_interrupt_switching(void) __attribute__ ((interrupt));
 ...
 * INT_TM02 (0x30)
 */
void r_Config_TAU0_2_Servo_interrupt(void) __attribute__ ((interrupt));
 ...
 */
// void r_Config_UART3_interrupt_send (void) __attribute__ ((interrupt));
void r_Config_CSI30_UART3_interrupt_switching(void) __attribute__ ((interrupt));

/*
 * INT_CSI31/INT_IIC31/INT_SR3 (0x3E)
 */
void r_Config_UART3_interrupt_receive (void) __attribute__ ((interrupt));
 ...
 */
void r_Config_TAU1_0_PWM_interrupt (void) __attribute__ ((interrupt));
// void r_Config_UARTA0_interrupt_error (void) __attribute__ ((interrupt));

/*
 * INT_TM11/INT_URE1 (0x5A)
 */
void r_Config_UARTA1_interrupt_error (void) __attribute__ ((interrupt));
 ...
 */
void r_Config_UART3_interrupt_error (void) __attribute__ ((interrupt));
 ...
 * INT_UR1 (0x70)
 */
void r_Config_UARTA1_interrupt_receive (void) __attribute__ ((interrupt));

...
extern int8_t g_tau07_used_flg;
// 0 : tau07 is not used by analogWrite, tone, nor servo
// 1 : tau07 is already used by analogWrite, so cannot be used by tone nor servo
// 2 : tau07 is already used by tone, so cannot be used by analogWrite nor servo
// 3 : tau07 is already used by servo, so cannot be used by tone nor analogWrite

#define TAU07_USED_BY_ANALOGWRITE   1
#define TAU07_USED_BY_TONE          2
#define TAU07_USED_BY_SERVO         3
#endif // G23_FPB_128P

...
extern "C" {
  ...
  extern volatile uint16_t g_csi30_tx_count;
...
#if     defined(CSI_CHANNEL5) && CSI_CHANNEL5 == 5
  case 5:
    Master_Create_          = R_Config_CSI21_Create;
    Master_Start_           = R_Config_CSI21_Start;
    Master_Stop_            = R_Config_CSI21_Stop;
    Master_Create_UserInit_ = R_Config_CSI21_Create_UserInit;
    Master_ClearStatus_     = R_Config_CSI21_ClearStatus;
    Master_Send_Receive_    = R_Config_CSI21_Send_Receive;
    Master_SetBitOrder_     = R_Config_CSI21_SetBitOrder;
    Master_SetDataMode_     = R_Config_CSI21_SetDataMode;
    Master_SetClockDivider_ = R_Config_CSI21_SetClockDivider;
    Master_SetClock_        = R_Config_CSI21_SetClock;
    Master_GetBitOrder_     = R_Config_CSI21_GetBitOrder;
    master_tx_count         = &g_csi21_tx_count;
    master_status_flag      = &g_csi21_status_flag;
    break;
#endif /* defined(CSI_CHANNEL5) && CSI_CHANNEL5 == 5 */
...
#if     defined(CSI_CHANNEL6) && CSI_CHANNEL6 == 6
  case 6:
    Master_Create_          = R_Config_CSI30_Create;
    Master_Start_           = R_Config_CSI30_Start;
    Master_Stop_            = R_Config_CSI30_Stop;
    Master_Create_UserInit_ = R_Config_CSI30_Create_UserInit;
    Master_ClearStatus_     = R_Config_CSI30_ClearStatus;
    Master_Send_Receive_    = R_Config_CSI30_Send_Receive;
    Master_SetBitOrder_     = R_Config_CSI30_SetBitOrder;
    Master_SetDataMode_     = R_Config_CSI30_SetDataMode;
    Master_SetClockDivider_ = R_Config_CSI30_SetClockDivider;
    Master_SetClock_        = R_Config_CSI30_SetClock;
    Master_GetBitOrder_     = R_Config_CSI30_GetBitOrder;
    master_tx_count         = &g_csi30_tx_count;
    master_status_flag      = &g_csi30_status_flag;
    break;
#endif /* defined(CSI_CHANNEL6) && CSI_CHANNEL6 == 6 */
  default:
    Master_Create_          =
    Master_Start_           =
    Master_Stop_            =

...
// #endif
#define analogInputToDigitalPin(p)  ((p < 6) ? (p) + 103 : -1)
...
#define PIN_WIRE_SDA0        (38) // P61
#define PIN_WIRE_SCL0        (37) // P60
...
#define ANALOG_PIN_7		12		// ANI
#define ANALOG_PIN_8		11		// ANI
#define ANALOG_PIN_9		10		// ANI
#define ANALOG_PIN_10		9		// ANI
#define ANALOG_PIN_11		8		// ANI
#define ANALOG_PIN_12		7		// ANI
#define ANALOG_PIN_13		6		// ANI
#define ANALOG_PIN_14		5		// ANI
#define ANALOG_PIN_15		4		// ANI
...
// Px0 -> 001, Px1 -> 0x02, Px2 -> 0x04, Px3 -> 0x08, Px4 -> 0x10, Px5 -> 0x20, Px6 -> 0x40, Px7 -> 0x80
#define DIGITAL_PIN_PMCA_0		0x08	/* P33	*/
#define DIGITAL_PIN_PMCA_1		0x10	/* P34	*/
#define DIGITAL_PIN_PMCA_2		0x20	/* P145	*/
#define DIGITAL_PIN_PMCA_3		0x40	/* P106	*/
#define DIGITAL_PIN_PMCA_4		0x20	/* P105	*/
#define DIGITAL_PIN_PMCA_5		0x10	/* P104	*/
#define DIGITAL_PIN_PMCA_6		0x08	/* P103	*/
#define DIGITAL_PIN_PMCA_7		0x00	/* P46	*/
#define DIGITAL_PIN_PMCA_8		0x00	/* P42	*/
#define DIGITAL_PIN_PMCA_9		0x02	/* P31	*/
...
#define DIGITAL_PIN_PMCA_14		0x10	/* P144	*/
#define DIGITAL_PIN_PMCA_15		0x08	/* P143	*/
#define DIGITAL_PIN_PMCA_16		0x04	/* P02	*/
#define DIGITAL_PIN_PMCA_17		0x08	/* P03	*/
#define DIGITAL_PIN_PMCA_18		0x08	/* P13	*/
#define DIGITAL_PIN_PMCA_19		0x10	/* P14	*/
...
#define DIGITAL_PIN_PMCA_24		0x20	/* P05	*/
...
#define DIGITAL_PIN_PMCA_30		0x01	/* P30 	*/
...
#define DIGITAL_PIN_PMCA_39		0x80	/* P17	*/
#define DIGITAL_PIN_PMCA_40		0x04	/* P12	*/
#define DIGITAL_PIN_PMCA_41		0x02	/* P11 	*/
#define DIGITAL_PIN_PMCA_42		0x01	/* P10	*/
...
#define DIGITAL_PIN_PMCA_49		0x04	/* P112	*/
#define DIGITAL_PIN_PMCA_50		0x08	/* P113	*/
#define DIGITAL_PIN_PMCA_51		0x10	/* P114	*/
#define DIGITAL_PIN_PMCA_52		0x02	/* P101	*/
#define DIGITAL_PIN_PMCA_53		0x02	/* P111	*/
#define DIGITAL_PIN_PMCA_54		0x40	/* P146	*/
...
#define DIGITAL_PIN_PMCA_59		0x04	/* P102	*/
#define DIGITAL_PIN_PMCA_60		0x40	/* P06	*/
...
#define DIGITAL_PIN_PMCA_70		0x02	/* P121	*/
#define DIGITAL_PIN_PMCA_71		0x04	/* P122	*/
#define DIGITAL_PIN_PMCA_72		0x08	/* P123	*/
#define DIGITAL_PIN_PMCA_73		0x10	/* P124	*/
#define DIGITAL_PIN_PMCA_74		0x20	/* P125	*/
#define DIGITAL_PIN_PMCA_75		0x40	/* P126	*/
#define DIGITAL_PIN_PMCA_76		0x80	/* P127	*/
#define DIGITAL_PIN_PMCA_77		0x00	/* P41	*/
#define DIGITAL_PIN_PMCA_78		0x00	/* P45	*/
#define DIGITAL_PIN_PMCA_79		0x04	/* P32	*/
...
#define DIGITAL_PIN_PMCA_85		0x02	/* P141	*/
#define DIGITAL_PIN_PMCA_86		0x04	/* P142	*/
#define DIGITAL_PIN_PMCA_87		0x01	/* P140	*/
#define DIGITAL_PIN_PMCA_88		0x01	/* P00	*/
#define DIGITAL_PIN_PMCA_89		0x40	/* P16	*/
#define DIGITAL_PIN_PMCA_90		0x00	/* P62	*/
#define DIGITAL_PIN_PMCA_91		0x00	/* P63	*/
#define DIGITAL_PIN_PMCA_92		0x00	/* P47	*/
#define DIGITAL_PIN_PMCA_93		0x01	/* P110	*/
#define DIGITAL_PIN_PMCA_94		0x10	/* P04	*/
#define DIGITAL_PIN_PMCA_95		0x80	/* P07	*/
#define DIGITAL_PIN_PMCA_96		0x20	/* P15	*/
...
//
#define TONE_PIN_2			2		// TO7
#define TONE_PIN_7			7		// TO5
#define TONE_PIN_8			8		// TO4
#define TONE_PIN_9			9		// TO3
#define TONE_PIN_39			39		// TO2
#define TONE_PIN_59			59		// TO6

#define TONE_PIN_10			10		// T1O
#define TONE_PIN_11			11		// T11
#define TONE_PIN_12			12		// T12
#define TONE_PIN_13			13		// T13
#define TONE_PIN_6			6		// T14
#define TONE_PIN_5			5		// T15
#define TONE_PIN_4			4		// T16
#define TONE_PIN_3			3		// T17
...
#define IS_PIN_I2C(p)           ((p) == PIN_WIRE_SDA0 || (p) == PIN_WIRE_SCL0 || (p) == PIN_WIRE_SDA1 || (p) == PIN_WIRE_SCL1)
#define IS_PIN_SPI(p)           ((p) == SS || (p) == MOSI || (p) == MISO || (p) == SCK)

#define IS_PIN_SERIAL(p)        (IS_PIN_SERIAL0(p) || IS_PIN_SERIAL1(p) || IS_PIN_SERIAL2(p) || IS_PIN_SERIAL3(p) || IS_PIN_SERIAL4(p))

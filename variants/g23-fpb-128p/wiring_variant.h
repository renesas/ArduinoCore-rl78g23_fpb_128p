...
// #define EXTERNAL_INTERRUPT_2	3  // P30 not available
#define EXTERNAL_INTERRUPT_2    0
#define EXTERNAL_INTERRUPT_3    8
#define EXTERNAL_INTERRUPT_4    9
#define EXTERNAL_INTERRUPT_5    10
#define EXTERNAL_INTERRUPT_6    11
#define EXTERNAL_INTERRUPT_7    6
#define EXTERNAL_INTERRUPT_8    5

// #define	PWM_CH_NUM	(13)
